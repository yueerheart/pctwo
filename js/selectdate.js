...
(function (win, doc) {
	...
	selectDate.prototype = {
		...
		init : function () {
			var defaultYear = this.yearEle.getAttribute("data-dval") || 0,
			defaultMonth = this.monthEle.getAttribute("data-dval") || 0,
			defaultDay = this.dayEle.getAttribute("data-dval") || 0;
		
			this.addYear();
			this.yearEle.value = defaultYear;
			this.addMonth();
			this.monthEle.value = defaultMonth;
			this.addDay();
			this.dayEle.value = defaultDay;
